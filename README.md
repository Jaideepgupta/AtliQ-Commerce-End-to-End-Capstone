...
![AtliQ Commerce Architecture](Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/atliq_commerce_architecture.svg)
...
`Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M2_ADF/`
...
`Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M3_SILVER/`
...
dbt evidence is available in: `Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M4_GOLD_DBT/`
...
The project also includes nightly execution evidence in: `Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M5_NIGHTLY_SYNC/`
...
Supporting screenshots are stored in: `Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M5_NIGHTLY_SYNC/`
...
Dashboard artifacts and evidence are available in: `Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M6_FABRIC/`
...
CI/CD evidence is available in: `Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M7_CICD/`

---

# 🟢 Phase 2 — Real-Time Data Engineering

Phase 2 adds a real-time processing lane alongside the Phase 1 batch platform.
...
The Phase 2 implementation is intentionally independent of the Phase 1 deployment. It demonstrates how a real-time lane can operate alongside an existing batch data platform.
...
Bronze events are parsed using an explicit schema and transformed into structured records.
...
The watermark helps manage late-arriving events while bounding streaming state. Deduplication prevents repeated events from being processed as separate business events.

---

## Gold Streaming

Only successful payment events are used for revenue aggregation:
...
Because the aggregation uses event time and watermarking, completed Gold windows can appear after the corresponding events arrive and the watermark advances sufficiently.

---

## Streaming Checkpoints

Each streaming query has its own checkpoint:
...
Separate checkpoints allow Bronze, Silver and Gold to maintain independent processing state and progress.
...
The first task checks whether events have arrived in the Silver table within the previous two hours.
...
This failure scenario was intentionally tested by stopping the producer and triggering the DAG.

### Table Maintenance

The `optimize_tables` task runs `OPTIMIZE` on:
...
- Freshness data-quality failure
- The expected failure message when no fresh events are available
...
GitHub Actions screenshots and supporting evidence are available in: `Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/evidence/M7_CICD/`
...
- 📄 **[View Project Report (PDF)](Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/Cdebasics_AtliQ_End_to_End_Data_Engineering_Project_Report.pdf)**
- 📝 **[Download Project Report (DOCX)](Phase%201%20End-to-End%20Batch%20Data%20Engineering_CB/Cdebasics_AtliQ_End_to_End_Data_Engineering_Project_Report.docx)**
